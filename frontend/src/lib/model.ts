...
export type Profile = Plain<workspace.Profile>;
export type User = Plain<workspace.User>;
...
export type GitStatus = Plain<workspace.GitStatus>;
export type GitFileChange = Plain<workspace.GitFileChange>;
